...
/**
 * @brief Initializes the border geometry as a rectangle wireframe.
 */
void GameWorld::InitializeBorders(){
    ...
    //Position attribute only (3 floats)
...
void GameWorld::Render(Shader& shader, const Matrix4& view, const Matrix4& projection){
    ...
    shader.SetUniformFloat3("u_Color", Vector3D(1.0f, 0.0f, 0.0f)); //Red
