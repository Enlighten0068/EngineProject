...
namespace Components{
     ...
     */
    struct TileScale{
        float ScaleX = 1.0f; //Texture repetitions per unit in the X-axis (1.0 = no repetition)
        float ScaleY = 1.0f; //Texture repetitions per unit in the Y-axis (1.0 = no repetition)
    };
}
