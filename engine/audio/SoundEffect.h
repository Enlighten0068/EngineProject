...
public:
    ...
    /**
     * @brief Loads a .wav file from a speecified location.
...
private:
    ...
    SDL_AudioSpec m_Spec; //Audio specification
    ...
    /**
     * @brief Open the shared audio device if not already open.
